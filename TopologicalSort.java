...
public class TopologicalSort {
    ...
    public TopologicalSort(String filename) { 
    ...
    private VertexList visit(VertexList vertexlist, VertexList sorted) {
        VertexList sort = sorted;
        VertexList vl = vertexlist;
        while (vl != null) {
    ...
    public static void main(String[] args) {
        TopologicalSort t = new TopologicalSort(args[0]);
